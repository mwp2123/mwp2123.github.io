...
* Data Manager and Data Scientist 
  ...
  + OSI Soft PI Administrator
    + Onboarded cell culture lab equipment online data to PI system
    + Maintained PI alarms for lab equipment
...
* Process Development Engineer
  ...
  + Late Stage Process Development
      + Led upstream process development for commercial processes
        ...
        + Scale Characterization - Modeling of scale independent process parameters to identify sources of variability between 2L and 40L SS bioreactor performance
...
JMP, JSL, R, R Markdown, R Shiny, Python, SAS, Git
